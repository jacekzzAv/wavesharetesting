...
void ui_Screen1_screen_init(void)
{
    ...
    lv_label_set_text(ui_Label1, "ARC");
    ...
    lv_label_set_text(ui_Label2, "Button");
    ...
    lv_obj_set_style_bg_color(ui_Switch1, lv_color_hex(0x160000), LV_PART_MAIN | LV_STATE_DEFAULT);
